									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												<div class="stat-panel-number h4 ">Smoke Concentation: 
												<span id="amit">
											...
											<a href="detail.php" class="block-anchor panel-footer text-center">FULL DETAIL &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
