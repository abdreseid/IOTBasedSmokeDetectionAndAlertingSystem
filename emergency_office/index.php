...
$stmt=$mysqli->prepare("SELECT email,password FROM emergency_office WHERE email=? and password=? ");
...
<head>
	...
	<title>Emergency_Office login</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Emergency Office Login</h2>
						<div class="row">
